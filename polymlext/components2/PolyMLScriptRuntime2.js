...
PolyMLScriptRuntime.prototype = {  
 ...
 GetScriptTypeID: function() {
  ...
  ShutDown: function() {log("wow22");},
  ParseVersion: function(aVersionStr/*, verFlags*/) {log("wow33");},
  CreateContext: function(ret) {log("wow44");},
  DropScriptObject: function(object) {log("wow55");},
  HoldScriptObject: function(object) {log("wow66");},
...
var PolyMLScriptRuntimeModule = {  
  ...
  {  
    ...
    aCompMgr.registerFactoryLocation(CLASS_ID, CLASS_NAME,   
        CONTRACT_ID_ID, aFileSpec, aLocation, aType);  
  },  
  ...
  {  
    ...
    if (aCID.equals(CLASS_ID))  
      return PolyMLScriptRuntimeFactory;  
...
is called. 
***********************************************************/  
//function NSGetModule(aCompMgr, aFileSpec) { return PolyMLScriptRuntimeModule; }
