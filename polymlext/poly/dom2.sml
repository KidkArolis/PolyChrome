...
struct
    ...
    (* element methods *)
    fun childNodes (HTMLElement e) = parse_element_list (exec_js_r e "childNodes" [])
    fun parentNode (HTMLElement e) = parse_element (exec_js_r e "parentNode" [])
    fun firstChild (HTMLElement e) = parse_element (exec_js_r e "firstChild" [])
    fun lastChild (HTMLElement e) = parse_element (exec_js_r e "lastChild" [])
    fun nextSibling (HTMLElement e) = parse_element (exec_js_r e "nextSibling" [])
    fun previousSibling (HTMLElement e) = parse_element (exec_js_r e "previousSibling" [])
    fun setInnerHTML (HTMLElement e) value = exec_js e "innerHTML" [arg.string value]
    fun getInnerHTML (HTMLElement e) = exec_js_r e "innerHTML" []
    fun setValue (HTMLElement e) value = exec_js e "value" [arg.string value]
    fun getValue (HTMLElement e) = exec_js_r e "value" []
    ...
    fun setStyle (HTMLElement e) attr value = exec_js e ("style."^attr) [arg.string value]
    fun getStyle (HTMLElement e) attr = exec_js e ("style."^attr) []

    (* events *)
    fun getClientX (Event e) = valOf (Int.fromString (exec_js_r e "clientX" []))
    fun getClientY (Event e) = valOf (Int.fromString (exec_js_r e "clientY" []))
    ...
    (* custom functions TODO: should be moved to DOMExtra *)
    fun getHTMLCollectionItem (HTMLCollection x) n = HTMLElement (exec_js_r x (Int.toString n) [])
