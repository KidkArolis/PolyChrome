...
var log = function (aMessage) {
    ...
    consoleService.logStringMessage("PolyMLScriptRuntime: " + aMessage);
}
/*********************************************************** 
 constants
 ***********************************************************/
// reference to the interface defined in nsIHelloWorld.idl  
const nsIScriptRuntime = Ci.nsIScriptRuntime;
...
PolyMLScriptRuntime.prototype =
{
    ...
    QueryInterface: function (aIID) {
        log("bow1" + aIID);
        if (!aIID.equals(Ci.nsIScriptRuntime) &&      
...
/*********************************************************** 
 ...
 createInstance(Ci.nsIHelloWorld); 
 
 ***********************************************************/
var PolyMLScriptRuntimeFactory = new Object();
...
//    }
//};
PolyMLScriptRuntimeFactory.createInstance = function (aOuter, aIID) {
    if (aOuter != null) throw Cr.NS_ERROR_NO_AGGREGATION;
//    return (new PolyMLScriptRuntime()).QueryInterface(aIID);
    log(aIID);
    if (!aIID.equals(Ci.nsIScriptRuntime) && !aIID.equals(Ci.nsISupports))
        throw Cr.NS_ERROR_NO_INTERFACE;
    return new PolyMLScriptRuntime();
}
/*********************************************************** 
